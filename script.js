...
// ============================================
// TYPEWRITER EFFECT (Write & Rewrite)
// ============================================
...
// ============================================
// GEOMETRIC SHAPES (generate with JS)
// ============================================
...
function createParticles() {
    ...
    const colors = ['rgba(212,175,55,0.6)', 'rgba(212,175,55,0.3)', 'rgba(224,200,116,0.4)'];
...
const caseStudies = {
    notion: {
        title: "LinkedIn Content Calendar System",
        subtitle: "Notion-based Content Planning for Consistent Brand Visibility",
        problem: "The client needed a structured system to plan, schedule, and track social media content consistently to maintain brand visibility and engagement.",
        process: "I created a 1-week LinkedIn content calendar in Notion with organized daily content topics, posting schedule, captions, content ideas, and posting status. I designed an easy-to-navigate dashboard for content tracking with clear workflows for consistency and productivity.",
        result: "✅ Improved organization and planning efficiency for social media management\n✅ Structured content workflow for consistency and productivity\n✅ Easy-to-navigate dashboard for content tracking",
        tools: ["Notion", "Content Planning", "Task Organization"]
    },
    skincare: {
        title: "Skincare Brand Support System",
        subtitle: "Operational Efficiency for a Growing Beauty Brand",
        problem: "The skincare brand needed a structured system to organize customer information, track orders, and manage client inquiries professionally.",
        process: "I organized customer and product information, assisted with mock customer support and inquiry responses, created structured systems for tracking orders and client details, designed branded support materials using Canva, and managed administrative and workflow-related tasks.",
        result: "✅ Successfully created a structured support system\n✅ Improved organization, customer experience, and operational efficiency\n✅ Branded support materials for consistent communication",
        tools: ["Google Workspace", "Canva", "Google Sheets"]
    },
    travel: {
        title: "Travel Planning Itinerary",
        subtitle: "Structured Logistics for Stress-Free Travel",
        problem: "The client needed well-organized travel itineraries with clear logistics to reduce stress and ensure smooth arrangements for busy professionals.",
        process: "I built structured travel itineraries with comprehensive logistics including flights, accommodations, activities, transportation, and contingency plans. I organized all details in a clear, accessible format.",
        result: "✅ Smooth, stress-free travel arrangements\n✅ Clear logistics and contingency planning\n✅ Organized itineraries for busy professionals",
        tools: ["Google Workspace", "Research", "Planning"]
    },
    google: {
        title: "Google Workspace Ops & Workflow Management",
        subtitle: "Streamlined Operations for Team Coordination",
        problem: "The client needed a structured system to manage administrative tasks and workflow coordination with clear accountability and visibility across the team.",
        process: "I implemented an organized workflow using Google Workspace, created comprehensive task brief documents defining responsibilities, timelines, and execution guidelines. I managed internal communication and coordinated team activities.",
        result: "✅ Streamlined operations system\n✅ Improved accountability through structured communication\n✅ Cohesive workflow management",
...
// ============================================
// WORK SAMPLES AUTO CAROUSEL (Continuous)
// ============================================
...
// ============================================
// TESTIMONIALS AUTO CAROUSEL (Continuous)
// ============================================
...
console.log('✨ Stella Igwe · Executive Virtual Assistant Portfolio ready!');